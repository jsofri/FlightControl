    ...
    public partial class MainWindow : Window
    {
        ...
        private void Start_Button_Click(object sender, RoutedEventArgs e)
        {
            if (ValidInput())
            {
                ...
                if (Connect(model) || (ErrorLabel.Content.ToString().StartsWith("Unable")))
                {
                ...
                {
                    ErrorLabel.Content = "Unable to connect to server\nClick start to move controls purposelessly";
                }
            }
            else
            {
                ErrorLabel.Content = "Invalid IP/ Port";
            }
        }
